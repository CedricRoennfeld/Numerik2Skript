...
\begin{colboxBreakable}{Beispiel}
  ...
  \begin{center}
    \includegraphics[width=0.45\textwidth]{figures/zeit_sinus_ungedämpft.png}
    \hfill
    \includegraphics[width=0.45\textwidth]{figures/spektrum_sinus_ungedämpft.png}
  \end{center}
  ...
  schwingen, so erhalten wir 
    ...
    \begin{center}
      \includegraphics[width=0.45\textwidth]{figures/zeit_sinus_gedämpft.png}
      \hfill
      \includegraphics[width=0.45\textwidth]{figures/spektrum_sinus_gedämpft.png}
    \end{center}
